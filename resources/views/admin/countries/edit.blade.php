                ...
                <form action="{{ route('admin.countries.update', $country->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('code') is-invalid @enderror" 
                               id="code" name="code" value="{{ old('code', $country->code) }}" maxlength="2" required style="text-transform: uppercase;">
                        @error('code')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                               id="sort_order" name="sort_order" value="{{ old('sort_order', $country->sort_order) }}" min="0">
                        @error('sort_order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <button type="submit" class="btn text-white" style="background-color: #6cc2b6; border-color: #6cc2b6;">Update Country</button>
                </form>
            </div>
        </div>
    </div>
